...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">upGrad</a>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
      <div class="container">
        <h1 class="masthead-heading mb-0">upGrad Customer Relationship Management System</h1>
  ...
  <footer class="py-5">
    <div class="container">
      <p class="m-0 text-center text-white small">Copyright &copy; upGrad <?= date("Y-m-d") ?></p>
    </div>
    <!-- /.container -->
  </footer>
